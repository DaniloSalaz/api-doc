...
export class PetService {
    ...
    public findPetsByStatus(status: Array<'available' | 'pending' | 'sold'>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/xml' | 'application/json'}): Observable<any> {
        ...
        let responseType: 'text' | 'json' = 'json';
        if(httpHeaderAcceptSelected && ((httpHeaderAcceptSelected.startsWith('text') || httpHeaderAcceptSelected.startsWith('application/xml')) || httpHeaderAcceptSelected.startsWith('application/xml'))) {
            responseType = 'text';
        }
